...
namespace BusinessLayer.DAL
{
    public class DAL_SPECIFIC_GRAVITY_TEST
    {
        ...
        public Specific_Gravity_Abs Edit_Specific_Gravity_Entry(decimal Test_ID)
        {
            ...
            Specific_Gravity_Abs _objSPGR = new Specific_Gravity_Abs();

            List<Specific_Gravity_Abs> _list = new List<Specific_Gravity_Abs>();
            Specific_Gravity_Abs dtl = null;
            DataTable dt = ds.Tables[0];
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                _objSPGR = new Specific_Gravity_Abs();
                ...
                _objSPGR.Date = Convert.ToString(dt.Rows[0]["Date"]);
        ...
        public string SPECIFIC_GRAVITY_ENTRY(string Emp_Code, Specific_Gravity_Abs _SPGRAVITY, out ResultMessage oblMsg)
        {
            ...
            using (var connection = new SqlConnection(sqlConnection.GetConnectionString_SGX()))
            {
                ...
                try
                {
                        ...
                        SqlParameter[] param2 =
                                ...
                                new SqlParameter("@ERRORSTR", SqlDbType.VarChar, 200)
                               ,new SqlParameter("@Test_Dtl_ID", SqlDbType.Decimal)  
                               ,new SqlParameter("@Test_ID" ,(_SPGRAVITY.Test_ID == null)? (object)DBNull.Value : _SPGRAVITY.Test_ID) 
                               //,new SqlParameter("@Determination", (_SPGRAVITY.Determination == null) ? "" : _SPGRAVITY.Determination)
